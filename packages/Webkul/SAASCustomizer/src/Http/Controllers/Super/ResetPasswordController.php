...
/**
 * Super Admin reset password controller
 *
...
class ResetPasswordController extends Controller
{
    ...
    public function store()
    {
        ...
        $response = $this->broker()->reset(
            request(['email', 'password', 'password_confirmation', 'token']), function ($superAdmin, $password) {
                $this->resetPassword($superAdmin, $password);
            }
        );
     ...
     * @return void
     */
    protected function resetPassword($superAdmin, $password)
    {
