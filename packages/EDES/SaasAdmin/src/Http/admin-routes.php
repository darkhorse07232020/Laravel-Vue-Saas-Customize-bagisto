...
Route::group(['middleware' => ['web', 'admin-locale']], function () {
	Route::prefix(config('app.admin_url'))->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            //DataGrid Export
            Route::post(config('app.admin_url') . '/export', 'EDES\SaasAdmin\Http\Controllers\ExportController@export')->name('admin.datagrid.export');
            ...
            Route::prefix('cms')->group(function () {
                Route::namespace('Webkul\CMS\Http\Controllers\Admin')->group(function () {
            ...
            Route::prefix('company')->group(function() {
                Route::namespace('Webkul\SAASCustomizer\Http\Controllers\Admin')->group(function () {
                    Route::get('/profile', 'CompanyProfileController@index')->defaults('_config', [
                        'view' => 'saas::admin.details'
                    ])->name('company.profile.index');
        
                    Route::post('/profile', 'CompanyProfileController@update')->defaults('_config', [
                        'redirect' => 'company.profile.index'
                    ])->name('company.profile.update');
        
                    Route::get('/address', 'CompanyAddressController@index')->defaults('_config', [
                        'view' => 'saas::admin.address.index'
                    ])->name('company.address.index');
        
                    Route::get('/address/create', 'CompanyAddressController@create')->defaults('_config', [
                        'view' => 'saas::admin.address.create'
                    ])->name('company.address.create');
        
                    Route::post('/address/create', 'CompanyAddressController@store')->defaults('_config', [
                        'redirect' => 'company.address.index'
                    ])->name('company.address.store');
        
                    Route::get('/address/edit/{id}', 'CompanyAddressController@edit')->defaults('_config', [
                        'view' => 'saas::admin.address.edit'
                    ])->name('company.address.edit');
        
                    Route::post('/address/{id}', 'CompanyAddressController@update')->defaults('_config', [
                        'redirect' => 'company.address.index'
                    ])->name('company.address.update');
        
                    Route::post('/address/delete/{id}', 'CompanyAddressController@destroy')->defaults('_config', [
                        'redirect' => 'company.address.index'
